...
import { Building2, ArrowRight, ShieldCheck, Sparkles, ExternalLink, User, Phone } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background font-sans flex flex-col">
      ...
      <header className="bg-white border-b border-border h-16 flex items-center justify-between px-4 sm:px-8 shadow-sm">
        ...
        <a
          ...
          className="flex items-center gap-1.5 bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold text-xs py-2 px-4 rounded-lg border border-slate-200 transition-all cursor-pointer"
        >
